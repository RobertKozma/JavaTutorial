...
//        }
    ...
    public static void printareValoriWhile(){
        ...
        System.out.println("Valoare dupa parcurgerea de while este "+valoare);
    }
    ...
    public static void printareValoridoWhile(){
        ...
        System.out.println("Valoare dupa parcurgerea de do-while este "+valoare);
    }

    public static void printareValoriFor(){

        //sintaxa "for": for (initializare;conditie;incremetarea valorii dupa)
